                  ...
                  <div className='summary__price__wrapper'>
                    <div className='summary__price'>
                      ...
                      <p className='summary__price__ammount'>
                        {currencyFormatter.format(cartTotalAmmount + cartTotalAmmount * 0.23)}
                      </p>
                    </div>
                    <div className='summary__price'>
                      <p className='summary__price__heading'>SHIPPING</p>
                      <p className='summary__price__ammount'>{currencyFormatter.format(50)}</p>
                    </div>
                    <div className='summary__price'>
                      <p className='summary__price__heading'>VAT (INCLUDED)</p>
                      <p className='summary__price__ammount'>{currencyFormatter.format(cartTotalAmmount * 0.23)}</p>
                    </div>
                    <div className='summary__price total'>
                      <p className='summary__price__heading'>GRAND TOTAL</p>
                      <p className='summary__price__ammount'>
                        {currencyFormatter.format(cartTotalAmmount + cartTotalAmmount * 0.23 + 50)}
                      </p>
                    </div>
                  </div>
